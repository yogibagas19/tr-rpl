    ...
    <HeaderAdmin />
      <main>
        <div className='flex w-full'>
          <div className="sidebar w-1/4 h-[150vh] border-r-2">
          ...
          <div className='mx-auto'>
            <img src="dashboard1.png" alt="" className='mt-10' />
            <img src="maintenis.png" alt="" className='mt-10' />
            <img src="pengunjung.png" alt="" className='mt-10' />
            <img src="rekening.png" alt="" className='mt-10 mb-10' />
          </div>
        </div>
      </main>
      <Footers />
